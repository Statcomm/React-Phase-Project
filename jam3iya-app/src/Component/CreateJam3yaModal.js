...
function CreateJam3yaModal() {
  ...
  const handleChange = (e) => {
    setNewJam3ya({ ...newJam3ya, [e.target.name]: e.target.value });
  };
          ...
          <Form onSubmit={handleSubmit}>
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                name="title"
                type="text"
                placeholder="enter your Jam3iya name  "
              />
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                name="amount"
                type="number"
                placeholder="Tcham tabi bil shahir?"
              />
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                name="limit"
                type="number"
                placeholder="Tcham nass maximum?"
              />
            </Form.Group>
